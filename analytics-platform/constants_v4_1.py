...
display_size = (1300, 720) #the monitor display resolution. if fullscr, then resol should match monitor's
disp = Window(size=display_size, units='pix', color = BGC, screen = 0, fullscr = False) # define the window of the experiment. KEEP FULLSCR TO FALSE
...
Firstly, you are welcome to stop at any time; just let the experimenter know!\n\n\
In this experiment, you will see a white cross in the middle, and two boxes to the sides.\n\
You will see one of the boxes flash. Ignore this!\n\n\
Press the LEFT ARROW KEY when you see a circle to the left.\n\
Press the RIGHT ARROW KEY when you see a circle to the right.\n\
...
Press the Esc key to exit and let the experimenter know'
