...
save_directory = r"C:\Users\55145178\Desktop\Brain\patient_app"
...
# ===== Display window =====
disp = Window(size=win_dimension, pos=(0, 0), color=background_color, colorSpace="rgb255", fullscr=True, units="pix")
